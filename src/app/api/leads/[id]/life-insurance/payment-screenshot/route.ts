...
export async function POST(
  ...
  try {
    ...
    const uploadsDir = path.join(process.cwd(), 'public', 'uploads', 'life-insurance', 'payment-screenshots');
    ...
    const screenshotUrl = `/uploads/life-insurance/payment-screenshots/${filename}`;
